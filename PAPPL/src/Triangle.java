...
public class Triangle {
    ...
    private Point3D Barycentre2D(){
        Point3D P = new Point3D((A.getAbscisse()+B.getAbscisse()+C.getAbscisse())/3,(A.getOrdonnee()+B.getOrdonnee()+C.getOrdonnee())/3,0);
        return P;
    }
    private void pointInclus(Point2D P){
